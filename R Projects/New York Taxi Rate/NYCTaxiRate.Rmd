...
hist(train$fare_amount)
```
##What we will do now is use simple random forest and see if the results changes after doing any of the pre-processing technique such as nornalization 
...
#Checking the fields that are hoghly skewed
```{r}
